...
* Test Scenarios
  ...
  * The boundary value
    * The haystack equals the needle.
    * The haystack and needle have the minimum length 1.
    * The needle occurs multiple times, so the first occurrence should be returned.
...
| strStr(String, String) | 52/52               | 100% | 14/14           | 100% | 0      | 8    | 0      | 13    | 0      | 1       |
