...
| lengthOfLastWord(String) | 35                  | 100% | 9               | 90%  | 1      | 6    | 0      | 10    | 0      | 1       |
| Total                    | 3 of 38             | 92%  | 1 of 10         | 100% | 2      | 7    | 1      | 11    | 1      | 2       |

The test does not have 100% line coverage as there is no class instantiation. 

If we want to maximum the branch and condition coverage to 100%, the case that the input is an empty string should be considered. However, the constraint exists: "There is at least one word in the string." 
...
The survive mutant is a change to conditional boundary in line 22:
